"""
Das Eisenatom - YouTube Version (16:9, 4K)
The Iron Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Eisen-Feld
...
ELEMENT_SYMBOL = "Fe"
ELEMENT_NUMBER = 26
ELEMENT_NAME_DE = "Eisen"
ELEMENT_NAME_EN = "Iron"
ELEMENT_LATIN = "Ferrum"
ELEMENT_MASS = "55.85 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 26
ELEMENT_NEUTRONS = 30

ELECTRON_CONFIG = [2, 8, 14, 2, 0, 0, 0]
...
class IronAtomDE(IronAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class IronAtomEN(IronAtom):
    def __init__(self, **kwargs):
