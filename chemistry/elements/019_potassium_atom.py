"""
Das Kaliumatom - YouTube Version (16:9, 4K)
The Potassium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Kalium-Feld
...
ELEMENT_SYMBOL = "K"
ELEMENT_NUMBER = 19
ELEMENT_NAME_DE = "Kalium"
ELEMENT_NAME_EN = "Potassium"
ELEMENT_LATIN = "Kalium"
ELEMENT_MASS = "39.10 u"
ELEMENT_GROUP = "alkali"
ELEMENT_PROTONS = 19
ELEMENT_NEUTRONS = 20

ELECTRON_CONFIG = [2, 8, 8, 1, 0, 0, 0]
...
class PotassiumAtomDE(PotassiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class PotassiumAtomEN(PotassiumAtom):
    def __init__(self, **kwargs):
