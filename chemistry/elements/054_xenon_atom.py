"""
Das Xenonatom - YouTube Version (16:9, 4K)
The Xenon Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Xenon-Feld
...
ELEMENT_SYMBOL = "Xe"
ELEMENT_NUMBER = 54
ELEMENT_NAME_DE = "Xenon"
ELEMENT_NAME_EN = "Xenon"
ELEMENT_LATIN = "Xenon"
ELEMENT_MASS = "131.29 u"
ELEMENT_GROUP = "noble"
ELEMENT_PROTONS = 54
ELEMENT_NEUTRONS = 77

ELECTRON_CONFIG = [2, 8, 18, 18, 8, 0, 0]
...
class XenonAtomDE(XenonAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class XenonAtomEN(XenonAtom):
    def __init__(self, **kwargs):
