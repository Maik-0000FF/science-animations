"""
Das Kryptonatom - YouTube Version (16:9, 4K)
The Krypton Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Krypton-Feld
...
ELEMENT_SYMBOL = "Kr"
ELEMENT_NUMBER = 36
ELEMENT_NAME_DE = "Krypton"
ELEMENT_NAME_EN = "Krypton"
ELEMENT_LATIN = "Krypton"
ELEMENT_MASS = "83.80 u"
ELEMENT_GROUP = "noble"
ELEMENT_PROTONS = 36
ELEMENT_NEUTRONS = 48

ELECTRON_CONFIG = [2, 8, 18, 8, 0, 0, 0]
...
class KryptonAtomDE(KryptonAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class KryptonAtomEN(KryptonAtom):
    def __init__(self, **kwargs):
