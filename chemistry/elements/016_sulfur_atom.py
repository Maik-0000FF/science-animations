"""
Das Schwefelatom - YouTube Version (16:9, 4K)
The Sulfur Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Schwefel-Feld
...
ELEMENT_SYMBOL = "S"
ELEMENT_NUMBER = 16
ELEMENT_NAME_DE = "Schwefel"
ELEMENT_NAME_EN = "Sulfur"
ELEMENT_LATIN = "Sulphur"
ELEMENT_MASS = "32.07 u"
ELEMENT_GROUP = "nonmetal"
ELEMENT_PROTONS = 16
ELEMENT_NEUTRONS = 16

ELECTRON_CONFIG = [2, 8, 6, 0, 0, 0, 0]
...
class SulfurAtomDE(SulfurAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class SulfurAtomEN(SulfurAtom):
    def __init__(self, **kwargs):
