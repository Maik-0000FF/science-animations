"""
Das Silberatom - YouTube Version (16:9, 4K)
The Silver Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Silber-Feld
...
ELEMENT_SYMBOL = "Ag"
ELEMENT_NUMBER = 47
ELEMENT_NAME_DE = "Silber"
ELEMENT_NAME_EN = "Silver"
ELEMENT_LATIN = "Argentum"
ELEMENT_MASS = "107.87 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 47
ELEMENT_NEUTRONS = 61

ELECTRON_CONFIG = [2, 8, 18, 18, 1, 0, 0]
...
class SilverAtomDE(SilverAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class SilverAtomEN(SilverAtom):
    def __init__(self, **kwargs):
