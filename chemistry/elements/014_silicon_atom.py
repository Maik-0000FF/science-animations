"""
Das Siliciumatom - YouTube Version (16:9, 4K)
The Silicon Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Silicium-Feld
...
ELEMENT_SYMBOL = "Si"
ELEMENT_NUMBER = 14
ELEMENT_NAME_DE = "Silicium"
ELEMENT_NAME_EN = "Silicon"
ELEMENT_LATIN = "Silicium"
ELEMENT_MASS = "28.09 u"
ELEMENT_GROUP = "metalloid"
ELEMENT_PROTONS = 14
ELEMENT_NEUTRONS = 14

ELECTRON_CONFIG = [2, 8, 4, 0, 0, 0, 0]
...
class SiliconAtomDE(SiliconAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class SiliconAtomEN(SiliconAtom):
    def __init__(self, **kwargs):
