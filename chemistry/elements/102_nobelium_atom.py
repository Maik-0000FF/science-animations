"""
Das Nobeliumatom - YouTube Version (16:9, 4K)
The Nobelium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Nobelium-Feld
...
ELEMENT_SYMBOL = "No"
ELEMENT_NUMBER = 102
ELEMENT_NAME_DE = "Nobelium"
ELEMENT_NAME_EN = "Nobelium"
ELEMENT_LATIN = "Nobelium"
ELEMENT_MASS = "259 u"
ELEMENT_GROUP = "actinide"
ELEMENT_PROTONS = 102
ELEMENT_NEUTRONS = 157

ELECTRON_CONFIG = [2, 8, 18, 32, 32, 8, 2]
...
class NobeliumAtomDE(NobeliumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class NobeliumAtomEN(NobeliumAtom):
    def __init__(self, **kwargs):
