"""
Das Terbiumatom - YouTube Version (16:9, 4K)
The Terbium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Terbium-Feld
...
ELEMENT_SYMBOL = "Tb"
ELEMENT_NUMBER = 65
ELEMENT_NAME_DE = "Terbium"
ELEMENT_NAME_EN = "Terbium"
ELEMENT_LATIN = "Terbium"
ELEMENT_MASS = "158.93 u"
ELEMENT_GROUP = "lanthanide"
ELEMENT_PROTONS = 65
ELEMENT_NEUTRONS = 94

ELECTRON_CONFIG = [2, 8, 18, 27, 8, 2, 0]
...
class TerbiumAtomDE(TerbiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class TerbiumAtomEN(TerbiumAtom):
    def __init__(self, **kwargs):
