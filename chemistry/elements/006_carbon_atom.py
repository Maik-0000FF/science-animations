"""
Das Kohlenstoffatom - YouTube Version (16:9, 4K)
The Carbon Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Kohlenstoff-Feld
...
ELEMENT_SYMBOL = "C"
ELEMENT_NUMBER = 6
ELEMENT_NAME_DE = "Kohlenstoff"
ELEMENT_NAME_EN = "Carbon"
ELEMENT_LATIN = "Carboneum"
ELEMENT_MASS = "12.01 u"
ELEMENT_GROUP = "nonmetal"
ELEMENT_PROTONS = 6
ELEMENT_NEUTRONS = 6

ELECTRON_CONFIG = [2, 4, 0, 0, 0, 0, 0]
...
class CarbonAtomDE(CarbonAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class CarbonAtomEN(CarbonAtom):
    def __init__(self, **kwargs):
