"""
Das Holmiumatom - YouTube Version (16:9, 4K)
The Holmium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Holmium-Feld
...
ELEMENT_SYMBOL = "Ho"
ELEMENT_NUMBER = 67
ELEMENT_NAME_DE = "Holmium"
ELEMENT_NAME_EN = "Holmium"
ELEMENT_LATIN = "Holmium"
ELEMENT_MASS = "164.93 u"
ELEMENT_GROUP = "lanthanide"
ELEMENT_PROTONS = 67
ELEMENT_NEUTRONS = 98

ELECTRON_CONFIG = [2, 8, 18, 29, 8, 2, 0]
...
class HolmiumAtomDE(HolmiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class HolmiumAtomEN(HolmiumAtom):
    def __init__(self, **kwargs):
