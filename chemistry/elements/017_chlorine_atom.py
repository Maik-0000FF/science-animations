"""
Das Chloratom - YouTube Version (16:9, 4K)
The Chlorine Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Chlor-Feld
...
ELEMENT_SYMBOL = "Cl"
ELEMENT_NUMBER = 17
ELEMENT_NAME_DE = "Chlor"
ELEMENT_NAME_EN = "Chlorine"
ELEMENT_LATIN = "Chlorum"
ELEMENT_MASS = "35.45 u"
ELEMENT_GROUP = "halogen"
ELEMENT_PROTONS = 17
ELEMENT_NEUTRONS = 18

ELECTRON_CONFIG = [2, 8, 7, 0, 0, 0, 0]
...
class ChlorineAtomDE(ChlorineAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class ChlorineAtomEN(ChlorineAtom):
    def __init__(self, **kwargs):
