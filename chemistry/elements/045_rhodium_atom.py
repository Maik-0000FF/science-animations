"""
Das Rhodiumatom - YouTube Version (16:9, 4K)
The Rhodium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Rhodium-Feld
...
ELEMENT_SYMBOL = "Rh"
ELEMENT_NUMBER = 45
ELEMENT_NAME_DE = "Rhodium"
ELEMENT_NAME_EN = "Rhodium"
ELEMENT_LATIN = "Rhodium"
ELEMENT_MASS = "102.91 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 45
ELEMENT_NEUTRONS = 58

ELECTRON_CONFIG = [2, 8, 18, 16, 1, 0, 0]
...
class RhodiumAtomDE(RhodiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class RhodiumAtomEN(RhodiumAtom):
    def __init__(self, **kwargs):
