"""
Das Palladiumatom - YouTube Version (16:9, 4K)
The Palladium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Palladium-Feld
...
ELEMENT_SYMBOL = "Pd"
ELEMENT_NUMBER = 46
ELEMENT_NAME_DE = "Palladium"
ELEMENT_NAME_EN = "Palladium"
ELEMENT_LATIN = "Palladium"
ELEMENT_MASS = "106.42 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 46
ELEMENT_NEUTRONS = 60

ELECTRON_CONFIG = [2, 8, 18, 18, 0, 0, 0]
...
class PalladiumAtomDE(PalladiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class PalladiumAtomEN(PalladiumAtom):
    def __init__(self, **kwargs):
