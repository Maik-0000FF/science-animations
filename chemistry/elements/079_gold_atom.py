"""
Das Goldatom - YouTube Version (16:9, 4K)
The Gold Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Gold-Feld
3. Vereinfachtes Bohr-Atommodell mit 6 Schale(n)

Hinweis: Gold hat eine anomale Elektronenkonfiguration [Xe] 4f14 5d10 6s1
"""
...
ELEMENT_SYMBOL = "Au"
ELEMENT_NUMBER = 79
ELEMENT_NAME_DE = "Gold"
ELEMENT_NAME_EN = "Gold"
ELEMENT_LATIN = "Aurum"
ELEMENT_MASS = "196.97 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 79
ELEMENT_NEUTRONS = 118

ELECTRON_CONFIG = [2, 8, 18, 32, 18, 1, 0]
...
class GoldAtomDE(GoldAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class GoldAtomEN(GoldAtom):
    def __init__(self, **kwargs):
