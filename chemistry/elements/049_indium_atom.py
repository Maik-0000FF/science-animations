"""
Das Indiumatom - YouTube Version (16:9, 4K)
The Indium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Indium-Feld
...
ELEMENT_SYMBOL = "In"
ELEMENT_NUMBER = 49
ELEMENT_NAME_DE = "Indium"
ELEMENT_NAME_EN = "Indium"
ELEMENT_LATIN = "Indium"
ELEMENT_MASS = "114.82 u"
ELEMENT_GROUP = "post_transition"
ELEMENT_PROTONS = 49
ELEMENT_NEUTRONS = 66

ELECTRON_CONFIG = [2, 8, 18, 18, 3, 0, 0]
...
class IndiumAtomDE(IndiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class IndiumAtomEN(IndiumAtom):
    def __init__(self, **kwargs):
