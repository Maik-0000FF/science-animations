"""
Das Nickelatom - YouTube Version (16:9, 4K)
The Nickel Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Nickel-Feld
...
ELEMENT_SYMBOL = "Ni"
ELEMENT_NUMBER = 28
ELEMENT_NAME_DE = "Nickel"
ELEMENT_NAME_EN = "Nickel"
ELEMENT_LATIN = "Niccolum"
ELEMENT_MASS = "58.69 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 28
ELEMENT_NEUTRONS = 30

ELECTRON_CONFIG = [2, 8, 16, 2, 0, 0, 0]
...
class NickelAtomDE(NickelAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class NickelAtomEN(NickelAtom):
    def __init__(self, **kwargs):
