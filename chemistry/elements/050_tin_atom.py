"""
Das Zinnatom - YouTube Version (16:9, 4K)
The Tin Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Zinn-Feld
...
ELEMENT_SYMBOL = "Sn"
ELEMENT_NUMBER = 50
ELEMENT_NAME_DE = "Zinn"
ELEMENT_NAME_EN = "Tin"
ELEMENT_LATIN = "Stannum"
ELEMENT_MASS = "118.71 u"
ELEMENT_GROUP = "post_transition"
ELEMENT_PROTONS = 50
ELEMENT_NEUTRONS = 69

ELECTRON_CONFIG = [2, 8, 18, 18, 4, 0, 0]
...
class TinAtomDE(TinAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class TinAtomEN(TinAtom):
    def __init__(self, **kwargs):
