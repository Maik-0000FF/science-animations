"""
Das Radiumatom - YouTube Version (16:9, 4K)
The Radium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Radium-Feld
...
ELEMENT_SYMBOL = "Ra"
ELEMENT_NUMBER = 88
ELEMENT_NAME_DE = "Radium"
ELEMENT_NAME_EN = "Radium"
ELEMENT_LATIN = "Radium"
ELEMENT_MASS = "226 u"
ELEMENT_GROUP = "alkaline"
ELEMENT_PROTONS = 88
ELEMENT_NEUTRONS = 138

ELECTRON_CONFIG = [2, 8, 18, 32, 18, 8, 2]
...
class RadiumAtomDE(RadiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class RadiumAtomEN(RadiumAtom):
    def __init__(self, **kwargs):
