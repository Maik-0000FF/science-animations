"""
Das Cadmiumatom - YouTube Version (16:9, 4K)
The Cadmium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Cadmium-Feld
...
ELEMENT_SYMBOL = "Cd"
ELEMENT_NUMBER = 48
ELEMENT_NAME_DE = "Cadmium"
ELEMENT_NAME_EN = "Cadmium"
ELEMENT_LATIN = "Cadmium"
ELEMENT_MASS = "112.41 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 48
ELEMENT_NEUTRONS = 66

ELECTRON_CONFIG = [2, 8, 18, 18, 2, 0, 0]
...
class CadmiumAtomDE(CadmiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class CadmiumAtomEN(CadmiumAtom):
    def __init__(self, **kwargs):
