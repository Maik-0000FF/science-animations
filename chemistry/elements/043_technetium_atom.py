"""
Das Technetiumatom - YouTube Version (16:9, 4K)
The Technetium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Technetium-Feld
...
ELEMENT_SYMBOL = "Tc"
ELEMENT_NUMBER = 43
ELEMENT_NAME_DE = "Technetium"
ELEMENT_NAME_EN = "Technetium"
ELEMENT_LATIN = "Technetium"
ELEMENT_MASS = "98 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 43
ELEMENT_NEUTRONS = 55

ELECTRON_CONFIG = [2, 8, 18, 13, 2, 0, 0]
...
class TechnetiumAtomDE(TechnetiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class TechnetiumAtomEN(TechnetiumAtom):
    def __init__(self, **kwargs):
