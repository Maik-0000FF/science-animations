"""
Das Vanadiumatom - YouTube Version (16:9, 4K)
The Vanadium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Vanadium-Feld
...
ELEMENT_SYMBOL = "V"
ELEMENT_NUMBER = 23
ELEMENT_NAME_DE = "Vanadium"
ELEMENT_NAME_EN = "Vanadium"
ELEMENT_LATIN = "Vanadium"
ELEMENT_MASS = "50.94 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 23
ELEMENT_NEUTRONS = 28

ELECTRON_CONFIG = [2, 8, 11, 2, 0, 0, 0]
...
class VanadiumAtomDE(VanadiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class VanadiumAtomEN(VanadiumAtom):
    def __init__(self, **kwargs):
