"""
Das Natriumatom - YouTube Version (16:9, 4K)
The Sodium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Natrium-Feld
...
ELEMENT_SYMBOL = "Na"
ELEMENT_NUMBER = 11
ELEMENT_NAME_DE = "Natrium"
ELEMENT_NAME_EN = "Sodium"
ELEMENT_LATIN = "Natrium"
ELEMENT_MASS = "22.99 u"
ELEMENT_GROUP = "alkali"
ELEMENT_PROTONS = 11
ELEMENT_NEUTRONS = 12

ELECTRON_CONFIG = [2, 8, 1, 0, 0, 0, 0]
...
class SodiumAtomDE(SodiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class SodiumAtomEN(SodiumAtom):
    def __init__(self, **kwargs):
