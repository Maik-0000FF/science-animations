"""
Das Argonatom - YouTube Version (16:9, 4K)
The Argon Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Argon-Feld
...
ELEMENT_SYMBOL = "Ar"
ELEMENT_NUMBER = 18
ELEMENT_NAME_DE = "Argon"
ELEMENT_NAME_EN = "Argon"
ELEMENT_LATIN = "Argon"
ELEMENT_MASS = "39.95 u"
ELEMENT_GROUP = "noble"
ELEMENT_PROTONS = 18
ELEMENT_NEUTRONS = 22

ELECTRON_CONFIG = [2, 8, 8, 0, 0, 0, 0]
...
class ArgonAtomDE(ArgonAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class ArgonAtomEN(ArgonAtom):
    def __init__(self, **kwargs):
