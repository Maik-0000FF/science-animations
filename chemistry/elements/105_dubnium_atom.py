"""
Das Dubniumatom - YouTube Version (16:9, 4K)
The Dubnium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Dubnium-Feld
...
ELEMENT_SYMBOL = "Db"
ELEMENT_NUMBER = 105
ELEMENT_NAME_DE = "Dubnium"
ELEMENT_NAME_EN = "Dubnium"
ELEMENT_LATIN = "Dubnium"
ELEMENT_MASS = "268 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 105
ELEMENT_NEUTRONS = 163

ELECTRON_CONFIG = [2, 8, 18, 32, 32, 11, 2]
...
class DubniumAtomDE(DubniumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class DubniumAtomEN(DubniumAtom):
    def __init__(self, **kwargs):
