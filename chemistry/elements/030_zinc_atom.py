"""
Das Zinkatom - YouTube Version (16:9, 4K)
The Zinc Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Zink-Feld
...
ELEMENT_SYMBOL = "Zn"
ELEMENT_NUMBER = 30
ELEMENT_NAME_DE = "Zink"
ELEMENT_NAME_EN = "Zinc"
ELEMENT_LATIN = "Zincum"
ELEMENT_MASS = "65.38 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 30
ELEMENT_NEUTRONS = 34

ELECTRON_CONFIG = [2, 8, 18, 2, 0, 0, 0]
...
class ZincAtomDE(ZincAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class ZincAtomEN(ZincAtom):
    def __init__(self, **kwargs):
