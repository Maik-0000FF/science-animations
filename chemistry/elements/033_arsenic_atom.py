"""
Das Arsenatom - YouTube Version (16:9, 4K)
The Arsenic Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Arsen-Feld
...
ELEMENT_SYMBOL = "As"
ELEMENT_NUMBER = 33
ELEMENT_NAME_DE = "Arsen"
ELEMENT_NAME_EN = "Arsenic"
ELEMENT_LATIN = "Arsenicum"
ELEMENT_MASS = "74.92 u"
ELEMENT_GROUP = "metalloid"
ELEMENT_PROTONS = 33
ELEMENT_NEUTRONS = 42

ELECTRON_CONFIG = [2, 8, 18, 5, 0, 0, 0]
...
class ArsenicAtomDE(ArsenicAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class ArsenicAtomEN(ArsenicAtom):
    def __init__(self, **kwargs):
