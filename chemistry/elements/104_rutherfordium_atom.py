"""
Das Rutherfordiumatom - YouTube Version (16:9, 4K)
The Rutherfordium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Rutherfordium-Feld
...
ELEMENT_SYMBOL = "Rf"
ELEMENT_NUMBER = 104
ELEMENT_NAME_DE = "Rutherfordium"
ELEMENT_NAME_EN = "Rutherfordium"
ELEMENT_LATIN = "Rutherfordium"
ELEMENT_MASS = "267 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 104
ELEMENT_NEUTRONS = 163

ELECTRON_CONFIG = [2, 8, 18, 32, 32, 10, 2]
...
class RutherfordiumAtomDE(RutherfordiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class RutherfordiumAtomEN(RutherfordiumAtom):
    def __init__(self, **kwargs):
