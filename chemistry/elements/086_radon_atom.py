"""
Das Radonatom - YouTube Version (16:9, 4K)
The Radon Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Radon-Feld
...
ELEMENT_SYMBOL = "Rn"
ELEMENT_NUMBER = 86
ELEMENT_NAME_DE = "Radon"
ELEMENT_NAME_EN = "Radon"
ELEMENT_LATIN = "Radon"
ELEMENT_MASS = "222 u"
ELEMENT_GROUP = "noble"
ELEMENT_PROTONS = 86
...
ELECTRON_CONFIG = [2, 8, 18, 32, 18, 8, 0]
...
class RadonAtomDE(RadonAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class RadonAtomEN(RadonAtom):
    def __init__(self, **kwargs):
