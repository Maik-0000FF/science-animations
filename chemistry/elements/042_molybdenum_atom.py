"""
Das Molybdaenatom - YouTube Version (16:9, 4K)
The Molybdenum Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Molybdaen-Feld
...
ELEMENT_SYMBOL = "Mo"
ELEMENT_NUMBER = 42
ELEMENT_NAME_DE = "Molybdän"
ELEMENT_NAME_EN = "Molybdenum"
ELEMENT_LATIN = "Molybdaenum"
ELEMENT_MASS = "95.95 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 42
ELEMENT_NEUTRONS = 54

ELECTRON_CONFIG = [2, 8, 18, 13, 1, 0, 0]
...
class MolybdenumAtomDE(MolybdenumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class MolybdenumAtomEN(MolybdenumAtom):
    def __init__(self, **kwargs):
