"""
Das Sauerstoffatom - YouTube Version (16:9, 4K)
The Oxygen Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Sauerstoff-Feld
...
ELEMENT_SYMBOL = "O"
ELEMENT_NUMBER = 8
ELEMENT_NAME_DE = "Sauerstoff"
ELEMENT_NAME_EN = "Oxygen"
ELEMENT_LATIN = "Oxygenium"
ELEMENT_MASS = "16.00 u"
ELEMENT_GROUP = "nonmetal"
ELEMENT_PROTONS = 8
ELEMENT_NEUTRONS = 8

ELECTRON_CONFIG = [2, 6, 0, 0, 0, 0, 0]
...
class OxygenAtomDE(OxygenAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class OxygenAtomEN(OxygenAtom):
    def __init__(self, **kwargs):
