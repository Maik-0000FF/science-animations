"""
Das Erbiumatom - YouTube Version (16:9, 4K)
The Erbium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Erbium-Feld
...
ELEMENT_SYMBOL = "Er"
ELEMENT_NUMBER = 68
ELEMENT_NAME_DE = "Erbium"
ELEMENT_NAME_EN = "Erbium"
ELEMENT_LATIN = "Erbium"
ELEMENT_MASS = "167.26 u"
ELEMENT_GROUP = "lanthanide"
ELEMENT_PROTONS = 68
ELEMENT_NEUTRONS = 99

ELECTRON_CONFIG = [2, 8, 18, 30, 8, 2, 0]
...
class ErbiumAtomDE(ErbiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class ErbiumAtomEN(ErbiumAtom):
    def __init__(self, **kwargs):
