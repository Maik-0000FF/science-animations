"""
Das Promethiumatom - YouTube Version (16:9, 4K)
The Promethium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Promethium-Feld
...
ELEMENT_SYMBOL = "Pm"
ELEMENT_NUMBER = 61
ELEMENT_NAME_DE = "Promethium"
ELEMENT_NAME_EN = "Promethium"
ELEMENT_LATIN = "Promethium"
ELEMENT_MASS = "145 u"
ELEMENT_GROUP = "lanthanide"
ELEMENT_PROTONS = 61
ELEMENT_NEUTRONS = 84

ELECTRON_CONFIG = [2, 8, 18, 23, 8, 2, 0]
...
class PromethiumAtomDE(PromethiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class PromethiumAtomEN(PromethiumAtom):
    def __init__(self, **kwargs):
