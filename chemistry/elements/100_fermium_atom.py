"""
Das Fermiumatom - YouTube Version (16:9, 4K)
The Fermium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Fermium-Feld
...
ELEMENT_SYMBOL = "Fm"
ELEMENT_NUMBER = 100
ELEMENT_NAME_DE = "Fermium"
ELEMENT_NAME_EN = "Fermium"
ELEMENT_LATIN = "Fermium"
ELEMENT_MASS = "257 u"
ELEMENT_GROUP = "actinide"
ELEMENT_PROTONS = 100
ELEMENT_NEUTRONS = 157

ELECTRON_CONFIG = [2, 8, 18, 32, 30, 8, 2]
...
class FermiumAtomDE(FermiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class FermiumAtomEN(FermiumAtom):
    def __init__(self, **kwargs):
