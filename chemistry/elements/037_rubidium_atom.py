"""
Das Rubidiumatom - YouTube Version (16:9, 4K)
The Rubidium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Rubidium-Feld
...
ELEMENT_SYMBOL = "Rb"
ELEMENT_NUMBER = 37
ELEMENT_NAME_DE = "Rubidium"
ELEMENT_NAME_EN = "Rubidium"
ELEMENT_LATIN = "Rubidium"
ELEMENT_MASS = "85.47 u"
ELEMENT_GROUP = "alkali"
ELEMENT_PROTONS = 37
ELEMENT_NEUTRONS = 48

ELECTRON_CONFIG = [2, 8, 18, 8, 1, 0, 0]
...
class RubidiumAtomDE(RubidiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class RubidiumAtomEN(RubidiumAtom):
    def __init__(self, **kwargs):
