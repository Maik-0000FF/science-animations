"""
Das Zirconiumatom - YouTube Version (16:9, 4K)
The Zirconium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Zirconium-Feld
...
ELEMENT_SYMBOL = "Zr"
ELEMENT_NUMBER = 40
ELEMENT_NAME_DE = "Zirconium"
ELEMENT_NAME_EN = "Zirconium"
ELEMENT_LATIN = "Zirconium"
ELEMENT_MASS = "91.22 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 40
ELEMENT_NEUTRONS = 51

ELECTRON_CONFIG = [2, 8, 18, 10, 2, 0, 0]
...
class ZirconiumAtomDE(ZirconiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class ZirconiumAtomEN(ZirconiumAtom):
    def __init__(self, **kwargs):
