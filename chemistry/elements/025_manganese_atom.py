"""
Das Manganatom - YouTube Version (16:9, 4K)
The Manganese Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Mangan-Feld
...
ELEMENT_SYMBOL = "Mn"
ELEMENT_NUMBER = 25
ELEMENT_NAME_DE = "Mangan"
ELEMENT_NAME_EN = "Manganese"
ELEMENT_LATIN = "Manganum"
ELEMENT_MASS = "54.94 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 25
ELEMENT_NEUTRONS = 30

ELECTRON_CONFIG = [2, 8, 13, 2, 0, 0, 0]
...
class ManganeseAtomDE(ManganeseAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class ManganeseAtomEN(ManganeseAtom):
    def __init__(self, **kwargs):
