"""
Das Bariumatom - YouTube Version (16:9, 4K)
The Barium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Barium-Feld
...
ELEMENT_SYMBOL = "Ba"
ELEMENT_NUMBER = 56
ELEMENT_NAME_DE = "Barium"
ELEMENT_NAME_EN = "Barium"
ELEMENT_LATIN = "Barium"
ELEMENT_MASS = "137.33 u"
ELEMENT_GROUP = "alkaline"
ELEMENT_PROTONS = 56
ELEMENT_NEUTRONS = 81

ELECTRON_CONFIG = [2, 8, 18, 18, 8, 2, 0]
...
class BariumAtomDE(BariumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class BariumAtomEN(BariumAtom):
    def __init__(self, **kwargs):
