"""
Das Yttriumatom - YouTube Version (16:9, 4K)
The Yttrium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Yttrium-Feld
...
ELEMENT_SYMBOL = "Y"
ELEMENT_NUMBER = 39
ELEMENT_NAME_DE = "Yttrium"
ELEMENT_NAME_EN = "Yttrium"
ELEMENT_LATIN = "Yttrium"
ELEMENT_MASS = "88.91 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 39
ELEMENT_NEUTRONS = 50

ELECTRON_CONFIG = [2, 8, 18, 9, 2, 0, 0]
...
class YttriumAtomDE(YttriumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class YttriumAtomEN(YttriumAtom):
    def __init__(self, **kwargs):
