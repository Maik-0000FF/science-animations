"""
Das Niobatom - YouTube Version (16:9, 4K)
The Niobium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Niob-Feld
...
ELEMENT_SYMBOL = "Nb"
ELEMENT_NUMBER = 41
ELEMENT_NAME_DE = "Niob"
ELEMENT_NAME_EN = "Niobium"
ELEMENT_LATIN = "Niobium"
ELEMENT_MASS = "92.91 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 41
ELEMENT_NEUTRONS = 52

ELECTRON_CONFIG = [2, 8, 18, 12, 1, 0, 0]
...
class NiobiumAtomDE(NiobiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class NiobiumAtomEN(NiobiumAtom):
    def __init__(self, **kwargs):
