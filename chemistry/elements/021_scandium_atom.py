"""
Das Scandiumatom - YouTube Version (16:9, 4K)
The Scandium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Scandium-Feld
...
ELEMENT_SYMBOL = "Sc"
ELEMENT_NUMBER = 21
ELEMENT_NAME_DE = "Scandium"
ELEMENT_NAME_EN = "Scandium"
ELEMENT_LATIN = "Scandium"
ELEMENT_MASS = "44.96 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 21
ELEMENT_NEUTRONS = 24

ELECTRON_CONFIG = [2, 8, 9, 2, 0, 0, 0]
...
class ScandiumAtomDE(ScandiumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class ScandiumAtomEN(ScandiumAtom):
    def __init__(self, **kwargs):
