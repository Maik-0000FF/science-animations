"""
Das Franciumatom - YouTube Version (16:9, 4K)
The Francium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Francium-Feld
...
ELEMENT_SYMBOL = "Fr"
ELEMENT_NUMBER = 87
ELEMENT_NAME_DE = "Francium"
ELEMENT_NAME_EN = "Francium"
ELEMENT_LATIN = "Francium"
ELEMENT_MASS = "223 u"
ELEMENT_GROUP = "alkali"
ELEMENT_PROTONS = 87
ELEMENT_NEUTRONS = 136

ELECTRON_CONFIG = [2, 8, 18, 32, 18, 8, 1]
...
class FranciumAtomDE(FranciumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class FranciumAtomEN(FranciumAtom):
    def __init__(self, **kwargs):
