"""
Das Curiumatom - YouTube Version (16:9, 4K)
The Curium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Curium-Feld
...
ELEMENT_SYMBOL = "Cm"
ELEMENT_NUMBER = 96
ELEMENT_NAME_DE = "Curium"
ELEMENT_NAME_EN = "Curium"
ELEMENT_LATIN = "Curium"
ELEMENT_MASS = "247 u"
ELEMENT_GROUP = "actinide"
ELEMENT_PROTONS = 96
ELEMENT_NEUTRONS = 151

ELECTRON_CONFIG = [2, 8, 18, 32, 25, 9, 2]
...
class CuriumAtomDE(CuriumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class CuriumAtomEN(CuriumAtom):
    def __init__(self, **kwargs):
