"""
Das Bromatom - YouTube Version (16:9, 4K)
The Bromine Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Brom-Feld
...
ELEMENT_SYMBOL = "Br"
ELEMENT_NUMBER = 35
ELEMENT_NAME_DE = "Brom"
ELEMENT_NAME_EN = "Bromine"
ELEMENT_LATIN = "Bromum"
ELEMENT_MASS = "79.90 u"
ELEMENT_GROUP = "halogen"
ELEMENT_PROTONS = 35
ELEMENT_NEUTRONS = 44

ELECTRON_CONFIG = [2, 8, 18, 7, 0, 0, 0]
...
class BromineAtomDE(BromineAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class BromineAtomEN(BromineAtom):
    def __init__(self, **kwargs):
