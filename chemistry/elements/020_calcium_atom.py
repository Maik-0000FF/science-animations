"""
Das Calciumatom - YouTube Version (16:9, 4K)
The Calcium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Calcium-Feld
...
ELEMENT_SYMBOL = "Ca"
ELEMENT_NUMBER = 20
ELEMENT_NAME_DE = "Calcium"
ELEMENT_NAME_EN = "Calcium"
ELEMENT_LATIN = "Calcium"
ELEMENT_MASS = "40.08 u"
ELEMENT_GROUP = "alkaline"
ELEMENT_PROTONS = 20
ELEMENT_NEUTRONS = 20

ELECTRON_CONFIG = [2, 8, 8, 2, 0, 0, 0]
...
class CalciumAtomDE(CalciumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class CalciumAtomEN(CalciumAtom):
    def __init__(self, **kwargs):
