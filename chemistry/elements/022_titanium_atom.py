"""
Das Titanatom - YouTube Version (16:9, 4K)
The Titanium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Titan-Feld
...
ELEMENT_SYMBOL = "Ti"
ELEMENT_NUMBER = 22
ELEMENT_NAME_DE = "Titan"
ELEMENT_NAME_EN = "Titanium"
ELEMENT_LATIN = "Titanium"
ELEMENT_MASS = "47.87 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 22
ELEMENT_NEUTRONS = 26

ELECTRON_CONFIG = [2, 8, 10, 2, 0, 0, 0]
...
class TitaniumAtomDE(TitaniumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class TitaniumAtomEN(TitaniumAtom):
    def __init__(self, **kwargs):
