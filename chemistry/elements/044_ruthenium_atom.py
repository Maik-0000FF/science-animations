"""
Das Rutheniumatom - YouTube Version (16:9, 4K)
The Ruthenium Atom

Animation zeigt:
1. Vollstaendiges Periodensystem der Elemente
2. Zoom auf Ruthenium-Feld
...
ELEMENT_SYMBOL = "Ru"
ELEMENT_NUMBER = 44
ELEMENT_NAME_DE = "Ruthenium"
ELEMENT_NAME_EN = "Ruthenium"
ELEMENT_LATIN = "Ruthenium"
ELEMENT_MASS = "101.07 u"
ELEMENT_GROUP = "transition"
ELEMENT_PROTONS = 44
ELEMENT_NEUTRONS = 58

ELECTRON_CONFIG = [2, 8, 18, 15, 1, 0, 0]
...
class RutheniumAtomDE(RutheniumAtom):
    def __init__(self, **kwargs):
        super().__init__(lang="de", **kwargs)


class RutheniumAtomEN(RutheniumAtom):
    def __init__(self, **kwargs):
